 ...
 * 
 * <p>
 * Der TranslationService gibt fuer einen uebergebenen Key eine lokalisierte
 * Nachricht zurueck
 * 
...
public interface TranslationService {
	...
	/**
	 * Liefert die lokalisierte Nachricht fuer den uebergebenen Key zurueck.
	 * 
	 * <p>
	 * Falls zu dem Key keine Nachricht gefunden wurde, wird der Key selber als
	 * Default-Wert zurueck geliefert
	 * 
	 * @param key
