...
import org.osgibook.translation.TranslationPermission;
...
public class TranslationServiceImpl implements TranslationService {
	...
	public String getTranslation(String key) {
		...
		// Sicherstellen, dass der Aufrufer, die 'translate'-Permission besitzt
		// Um die volle Funktionalitaet des OSGi Conditional Permission Admin
		// Services zu nutzen, *muessen* Sie den SecurityManager verwenden (und
		// nicht den AccessController)
		SecurityManager securityManager = System.getSecurityManager();
		if (securityManager != null) {
			securityManager.checkPermission(new TranslationPermission("translate"));
		}
